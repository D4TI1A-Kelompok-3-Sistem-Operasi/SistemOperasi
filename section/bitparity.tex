...
\section{pengertian bit parity}
Bit parity merupakan bit tambahan yang disisipkan pada urutan bit bit data yang di transmisikan. 
Bit parity adalah bilangan biner yang di tambahkan untuk meyakinkan bahwa jumlah bit yang dikirimkan mempunyai angka satu yang selalu genap atau ganjil.
